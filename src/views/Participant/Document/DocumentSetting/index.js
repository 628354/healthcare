...
import DocumentForm from 'views/Participant/component/DocumentForm';
import EditDocName from 'views/Participant/component/EditDocName'
        ...
        <Box flex={1}>
          <Box display="flex" marginBottom="16px">
            <Box display="flex" justifyContent="space-between" alignItems="center" sx={{ width: "100%" }}>
              <h3 style={{ fontSize: "1.285rem", fontWeight: "500" }}>Participant Document Categories</h3>
              <Button variant="contained" onClick={handleAddButton}>Add New</Button>
            </Box>
          </Box>
        </Box>
