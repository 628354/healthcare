...
const DocumentForm = ({ setIsFormOpen }) => {
    ...
    const handleAdd = async (e) => {
        ...
        try {
            const firstApiResponse = await add(BASE_URL, 'insertDataGet?table=document_categories', firstData);
            ...
            <Grid container spacing={2} className='formSt'>
                <Grid item xs={12}>
                    <form onSubmit={handleAdd}>
                        ...
                        <Grid item xs={12}>
                            <Checkbox id='isConfidential' name='isConfidential' checked={isConfidential} onChange={(e) => setIsConfidential(e.target.checked)} />
