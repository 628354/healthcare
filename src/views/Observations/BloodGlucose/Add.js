...
useEffect(() => {
  ...
  const handleAdd = e => {
    ...
    const data = {
      ...
      glucose_date:formattedDate,
      glucose_time:formattedTime,
      glucose_stfid:staffId,
      glucose_prtcpntid:participant,
      glucose_read:reading,
      glucose_cmnt:comments,
    ...
    let endpoint = 'insertData?table=fms_obsglucose';
