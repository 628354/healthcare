...
import { BASE_URL, COMMON_ADD_FUN, COMMON_GET_FUN, COMMON_NEW_ADD, GET_PARTICIPANT_LIST, comanyId } from 'helper/ApiInfo'
...
const Add = ({setIsAdding,setShow }) => {
  ...
  const handleAdd = e => {
    ...
    let endpoint = "insertReporting?table=fms_prn_balance";
